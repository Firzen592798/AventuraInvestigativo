...
public class states_Player : DicionarioAcoes
{
	...
	public states_Player() {
		...
		Acao dialog1 = new MostrarDialogos(gm, new DialogLine("...", 0, 0));
		Acao dialog2 = new MostrarDialogos(gm, new DialogLine ("...!", 0, 0));

		ArrayList dialogoEduardo = new ArrayList ();
		dialogoEduardo.Add(new DialogLine ("Sinto que vou me arrepender em tê-la convidado a passar este fim-desemana na Mansão Christie. Você parece um tanto chateada.", 1, 1));
		dialogoEduardo.Add(new DialogLine ("Não se incomode comigo, Hastings. Você sabe que meu temperamento não é dos mais sociáveis.", 0, 0));
		dialogoEduardo.Add(new DialogLine ("Sim, sim... espero que se divirta, contudo.", 1,1));
		dialogoEduardo.Add(new DialogLine ("O que me incomoda mais é essa sensação de isolamento... não que seja de todo ruim passar um fim-de-semana mais isolado... mas ouça essa chuva...", 0,0));
		dialogoEduardo.Add(new DialogLine ("mesmo que qualquer um de nós precisasse ir lá fora por uma emergência sequer, não poderíamos de tão forte que cai a tempestade... ", 0,0));
		dialogoEduardo.Add(new DialogLine ("estar tão longe de tudo e a este nível de encarceramento desperta meus sentimentos mais alertas.", 0,0));
		dialogoEduardo.Add(new DialogLine ("Haha, não é necessário estar alerta na mansão Christie. É perfeitamente seguro... se não há como sair, não como entrar, ou seja: nenhum mal virá", 1,1));
		dialogoEduardo.Add(new DialogLine ("de fora.", 1, 1));
		dialogoEduardo.Add(new DialogLine ("Não me entenda mal, Hastings... não tenho medo de que algo entre aqui... me sinto terrivelmente desconfortável estando preso com essas pessoas...", 0,0));
		dialogoEduardo.Add(new DialogLine ("Os Christie? Eles são totalmente inofensivos pessoalmente... você deveria temê-los se fosse um empregado da empresa deles... estes sim sofrem em", 1,1));
		dialogoEduardo.Add(new DialogLine ("suas mãos...", 1, 1));
		dialogoEduardo.Add(new DialogLine ("Nunca se sabe Hastings... acredito que é melhor ficarmos com olhos e ouvidos preparados... estou sentindo que a noite vai ser longa..", 0,0));
		dialogoEduardo.Add(new DialogLine ("Sendo assim, vou tomar outra taça deste delicioso espumante enquanto a celebração não inicia de fato... Com licença, senhorita.", 1,1));
		dialogoEduardo.Add(new DialogLine ("Ora, largue as formalidades Capitão...", 0,0));
		dialogoEduardo.Add(new DialogLine ("Apenas uma cordialidade senhorita Terry... e para ser mais cordial vou te oferecer uma proposta, aceitas?", 1,1));
		dialogoEduardo.Add(new DialogLine ("Ora, diga Capitão.", 0,0));
		dialogoEduardo.Add(new DialogLine ("Os Christie são de fato, inofensivos... poderosos para os que não os conhecem bem, mas pessoas terrivelmente inseguras no fundo... Mesmo ", 1,1));
		dialogoEduardo.Add(new DialogLine ("assim, te trouxe aqui apenas para agradecer por ter me tirado daquelas situações arriscadas em que meti na época que investigávamos o ", 1, 1));
		dialogoEduardo.Add(new DialogLine ("caso do Maníaco do Circo. Não te trouxe para que se sentisse tão incomodada ao redor de pessoas que não conhece bem", 1, 1));
		dialogoEduardo.Add(new DialogLine ("durante todo um fim-de-semana... Se a chuva melhorar até amanhecer podemos ir embora se quiser...", 1, 1));
		dialogoEduardo.Add(new DialogLine ("Relaxe, capitão. Estou precisando socializar um pouco realmente. É só um fim de semana, não é possível que estas pessoas sejam tão insuportáveis Só preciso", 0,0));
		dialogoEduardo.Add(new DialogLine ("que você me explique o que tanto eles estão comemorando nesta ocasião, para que fique mais fácil de interagir caso alguém puxe assunto.", 0,0));
		dialogoEduardo.Add(new DialogLine ("Eu não estou bem certo... o senhor Joseph Christie me convidou apenas por gentileza e disse que eu trouxesse quem eu quisesse. ", 1,1));
		dialogoEduardo.Add(new DialogLine ("Somos muito amigos desde que eles se mudaram para esta cidadezinha e instalaram a Christie e Filhos S.A. por aqui.", 1,1));
		dialogoEduardo.Add(new DialogLine ("Faz cerca de 20 anos isso. Mas ouvi da Sra. Marques, a empregada, que esta é uma noite importante para a família e para a empresa.", 1,1));
		dialogoEduardo.Add(new DialogLine ("Eles estão prestes a decidir algo importante e optaram por esta reunião para fazer isto.", 1,1));
		dialogoEduardo.Add(new DialogLine ("Estou me sentindo terrivelmente pior: agora estou no meio de uma reunião de família... que furada Hastings!", 0,0));
		dialogoEduardo.Add(new DialogLine ("Hahaha, como você me diverte Jane. Bem, Se está realmente incomodada e curiosa assim como eu estou, faça um favor para nós dois: ", 1,1));
		dialogoEduardo.Add(new DialogLine ("descubra qual é a real razão desta cerimônia e me informe assim que tiver certeza do que se trata, o que acha? ", 1,1));
		dialogoEduardo.Add(new DialogLine ("Também servirá como maneira de socializar. ", 1,1));
		dialogoEduardo.Add(new DialogLine ("Não é má ideia... é exatamente isto que eu vou fazer!", 0,0));
